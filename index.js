...
console.log(`${chalk.cyanBright.bold("DiscoVolt")} | ${chalk.greenBright.bold("TheEdward")}`);

server.all("/", (req, res) => res.send(`<meta http-equiv="refresh" content="0; URL=https://discord.gg/hTP2DaMCnD"/>`));
